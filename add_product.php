        ...
        <section class="section-add-product">
            ...
            <div class="form-container">
                <div class="form-header">
                    <h2><i class="fas fa-plus-square"></i> Adicionar Novo Produto</h2>
                </div>
                <form action="./processar_produto.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                    <label for="input-categoria">Categoria do Produto:</label>
                    <select name="productCategory" id="input-categoria" required>
                    ...
                    <div class="form-group">
                        <button type="submit" value="Enviar"><i class="fas fa-cloud-upload-alt"></i> Adicionar Produto</button>
                    </div>
                </form>
            </div>
